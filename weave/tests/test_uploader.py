...
def test_derive_integrity_data_small_byte_count(tmp_path):
    ...
    # Expected blake hash of the string "0123456789". This string is used as
    # the file size is > 3*byte_count. So checksum is generated using bytes
    # from beginning, middle, and end (instead of whole file content).
