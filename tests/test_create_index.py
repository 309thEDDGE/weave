...
class TestCreateIndex():
    ...
    def setup_class(self):
        ...
        self.bucket_path = os.path.join(self.file_system_dir_path, self.test_bucket)
    ...
    def test_create_index_with_wrong_keys(self, patch):
        ...
        basket_dict = {}
        with self.fs.open(f'{self.bucket_path}/{self.basket_type}/5678/basket_manifest.json', 'rb') as f:
        ...
        self.fs.upload(basket_path, f'{self.bucket_path}/{self.basket_type}/5678/basket_manifest.json')
    ...
    def test_root_dir_does_not_exist(self, patch):
        ...
        with pytest.raises(FileNotFoundError, match = "'root_dir' does not exist"):
            minio_index = create_index_from_s3(os.path.join(self.file_system_dir_path,'NOT-A-BUCKET'))
